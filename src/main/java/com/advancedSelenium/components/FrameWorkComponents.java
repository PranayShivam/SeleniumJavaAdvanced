...
public class FrameWorkComponents {
    ...
    private static final String REPORT_FOLDER_LOCATION = System.getProperty("user.dir") + "\\Reports\\";
    private static final String PROPERTIES_FILE_LOCATION = System.getProperty("user.dir") + "\\src\\main\\resources\\application.properties";
    private static final String SCREEN_SHOT_LOCATION = System.getProperty("user.dir") + "\\ScreenShots\\";
